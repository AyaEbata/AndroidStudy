...
@Composable
fun AndroidStudioAppBar(
    currentScreen: AndroidStudyScreen,
...
@Composable
fun AndroidStudioApp() {
    val navController: NavHostController = rememberNavController()
    val backStackEntry by navController.currentBackStackEntryAsState()
    val currentScreen = AndroidStudyScreen.valueOf(
        backStackEntry?.destination?.route ?: AndroidStudyScreen.Menu.name
    )
